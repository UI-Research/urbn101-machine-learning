...
There are many applications of machine learning for applied econometrics. This will not be a focus of this training. Many useful links are available [here](https://urbanorg.box.com/s/hhl1n8b5sowiiq713qhy4mvhrgd3th10). 
...
3. Make predictions on the testing data set and estimate an error metric. 4. If the model is "good", then implement the model and make predictions.
